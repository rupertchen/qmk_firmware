...
[_BASE] = LAYOUT_ortho_5x12(
  ...
  KC_LCTL, KC_GRV,       KC_CAPS,      KC_LALT,      KC_BSPC,      LT(_RAISE,KC_DEL), LT(_LOWER,KC_ENT), KC_SPC,       KC_RGUI,      KC_LBRC,      KC_RBRC,         MO(_ADJUST)
),
...
[_LOWER] = LAYOUT_ortho_5x12(
  ...
  KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_NO, KC_PSCR,
...
[_RAISE] = LAYOUT_ortho_5x12(
  ...
  _______, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______, _______, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL, _______,
  _______, _______, _______, _______, _______, _______, KC_GRV,  KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, _______,
